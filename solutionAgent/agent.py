...
class ChatAgent:
    ...
    def understand_logs(self,logs):
        ...
        answer =  self.summarizer(f"""Imagine you are an expert software developer who helps in creating summary to ask websearch in detail.
                                Only give summary in form of paragraph with technical details and not solutions. Include error message in the summary, you will be punished for skipping any error or warning. Here are the logs: \n {logs} 
                                Summary: """)
        if answer[-1] != '.':
